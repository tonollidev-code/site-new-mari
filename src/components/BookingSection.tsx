        ...
        >
          ...
          {isSubmitted ? (
            ...
            <div className="text-center py-6 animate-in fade-in zoom-in-95 duration-300">
              ...
              <h3 className="text-2xl sm:text-3xl font-serif font-bold text-[#3F2519] mt-4 mb-2 tracking-tight">
                Agendamento solicitado com sucesso!
              </h3>

              <p className="text-xs sm:text-sm text-[#73594A] max-w-md mx-auto mb-8 leading-relaxed font-normal">
                Em breve entraremos em contato pelo WhatsApp para confirmar seu horário e enviar as instruções pré-atendimento.
              </p>

              {/* Summary Details */}
              <div className="bg-[#FCFAF7] p-5 rounded-2xl border border-[#EADEDA]/80 max-w-md mx-auto text-left mb-8 space-y-2 text-xs text-[#3F2519]">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                <button
                  ...
                  className="w-full sm:w-auto bg-white border border-[#DFD7CD] hover:border-[#C5A059] text-[#73594A] px-6 py-4 rounded-full text-xs font-bold uppercase tracking-widest transition-all hover:bg-[#FCFAF7] cursor-pointer"
                >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <label className="flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-[#3F2519] mb-2">
                ...
                <select
                  ...
                  className="w-full px-4 py-3.5 rounded-2xl border border-[#DFD7CD] focus:border-[#C5A059] focus:ring-1 focus:ring-[#C5A059] outline-none text-sm bg-white font-medium text-[#3F2519] transition-all"
                >
                  {services.map((s) => (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-2xl border border-[#DFD7CD] focus:border-[#C5A059] focus:ring-1 focus:ring-[#C5A059] outline-none text-sm bg-white font-medium text-[#3F2519] transition-all"
                  />
                </div>

                <div>
                  <div className="flex items-center justify-between mb-2">
                    <label className="flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-[#3F2519]">
                      ...
                      {availableTimeSlots.map((time) => (
                        <button
                          ...
                          className={`py-2 rounded-xl text-xs font-bold transition-all duration-200 cursor-pointer ${
                            selectedTime === time
                              ? 'bg-[#482D1F] text-[#FCFAF7] border border-[#482D1F] shadow-xs'
                              : 'bg-[#F8F5F2] text-[#73594A] border border-[#DFD7CD] hover:border-[#C5A059]/60 hover:bg-white'
                          }`}
                        >
                          {time}
                        </button>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-3 border-t border-[#EADEDA]/60">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-2xl border border-[#DFD7CD] focus:border-[#C5A059] focus:ring-1 focus:ring-[#C5A059] outline-none text-sm text-[#3F2519] transition-all"
                  />
                </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 rounded-2xl border border-[#DFD7CD] focus:border-[#C5A059] focus:ring-1 focus:ring-[#C5A059] outline-none text-sm text-[#3F2519] transition-all resize-none"
                />
              </div>
